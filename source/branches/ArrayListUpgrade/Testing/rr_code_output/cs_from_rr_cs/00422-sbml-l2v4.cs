...
;
	...
	public void evalEvents (double timeIn, double[] oAmounts)
	{
		...
		if (supportFunctions._lt(_y[0],(double)0.7)
	 == 1.0) {
	...
	private void InitializeDelays() { 
		_eventDelay[0] = new TEventDelayDelegate(delegate { return (double)8; } );
		_eventType[0] = true;
		_eventPersistentType[0] = true;
		_eventDelay[1] = new TEventDelayDelegate(delegate { return (double)12; } );
		_eventType[1] = true;
