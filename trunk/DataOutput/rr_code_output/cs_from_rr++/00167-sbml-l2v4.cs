...
class TModel : IModel
{
	...
	private double[] _gp = new double[8];           // Vector containing all the global parameters in the System  
	...
	string[] globalParameterTable = new string[8];
