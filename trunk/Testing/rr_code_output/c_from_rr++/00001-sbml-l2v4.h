...
//************************************************************************** 
	...
	char*                              mModelName;                                       
	char**                             mWarnings;                                       
	double                             _gp[2];                                 //Vector containing all the global parameters in the System  
	double*                            _lp[2];                                 //Vector containing all the local parameters in the System  
	double                             _y[1];                                  //Vector containing the concentrations of all floating species
	double                             _init_y[1];                             //Vector containing the initial concentrations of all floating species
	double                             _amounts[1];                            //Vector containing the amounts of all floating species 
	double                             _bc[2];                                 //Vector containing all the boundary species concentration values
	double                             _c[1];                                  //Vector containing all the compartment values   
	double                             _dydt[1];                               //Vector containing rates of changes of all species   
	double                             _rates[2];                              //Vector containing the rate laws of all reactions    
	...
	int                                numRules;                                       
	int                                numEvents;                                       
	char*                              variableTable[1];                       
	char*                              boundaryTable[2];                       
	char*                              globalParameterTable[2];                
	int                                localParameterDimensions[2];            
