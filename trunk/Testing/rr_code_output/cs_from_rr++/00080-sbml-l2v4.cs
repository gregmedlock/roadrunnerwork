...
class TModel : IModel
{
	...
	private double[] _ct = new double[3];           // Vector containing values of all conserved sums      
	...
	// User defined function:  func1
	public double func1 (double x, double y)
	{
		 return x*Math.Pow(y+1,-1);
	}
...
;
	...
	public void computeRules(double[] y) {
		_y[3] = func1 (_y[0],_gp[2])
	;
		_y[4] = multiply (_y[3],_gp[2])
	;
	}
