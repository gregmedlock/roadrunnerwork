...
class TModel : IModel
{
	...
	private double[] _ct = new double[4];           // Vector containing values of all conserved sums      
	...
	public void initializeInitialConditions ()
	{
		...
		_init_y[1] = (double)1.5E-006/ _c[0];
		_init_y[2] = (double)2E-006/ _c[0];
		_init_y[3] = (double)5E-007/ _c[0];
		_init_y[4] = (double)1E-006/ _c[0];
