...
class TModel : IModel
{
	...
	private double[][] _lp = new double[5][];       // Vector containing all the local parameters in the System  
	...
	private double[] _rates = new double[5];        // Vector containing the rate laws of all reactions    
	...
	int[] localParameterDimensions = new int[5];
	...
	public TModel ()  
	{
		...
		_lp[2] = new double[0];
		localParameterDimensions[3] = 0;
		_lp[3] = new double[0];
		localParameterDimensions[4] = 0;
		_lp[4] = new double[0];
	}
	...
	void loadSymbolTables() {
		...
		boundaryTable[0] = "X0";
		boundaryTable[1] = "X1";
		globalParameterTable[0] = "J0_VM1";
		globalParameterTable[1] = "J0_Keq1";
		globalParameterTable[2] = "J0_h";
		globalParameterTable[3] = "J4_V4";
		globalParameterTable[4] = "J4_KS4";
	}
	...
	public void evalModel (double timein, double[] oAmounts)
	{
		...
		_dydt[1] = + _rates[2] - _rates[3];
		_dydt[2] = + _rates[3] - _rates[4];
		_dydt[3] = + _rates[1] - _rates[2];
		convertToAmounts ();
	}
