...
class TModel : IModel
{
	...
	private double[][] _lp = new double[4][];       // Vector containing all the local parameters in the System  
	...
	private double[] _rates = new double[4];        // Vector containing the rate laws of all reactions    
	...
	int[] localParameterDimensions = new int[4];
...
;
	...
	public void evalModel (double timein, double[] oAmounts)
	{
		...
		_dydt[0] = + _rates[0] - _rates[1] - _rates[2] + _rates[3];
