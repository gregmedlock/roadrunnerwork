...
class TModel : IModel
{
	...
	private double[] _gp = new double[0];           // Vector containing all the global parameters in the System  
	...
	string[] globalParameterTable = new string[0];
