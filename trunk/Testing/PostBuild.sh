#! /usr/bin/bash
#This script carries out any post build needs, in the Testing folder.
#1: copy road runner dll's to the bin folder
...
SHARED_BINS=" \
$RR_LINK_FOLDER/RoadRunnerLib.dll
"

DEBUG_FILES=" \
$RR_LINK_FOLDER/RoadRunnerLib.tds
"
