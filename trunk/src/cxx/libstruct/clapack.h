...
extern "C" {
	...
	int dlabad_(doublereal *small__, doublereal *large);
	...
	int slabad_(real *small__, real *large);
	...
	int zgesdd_(char *jobz, integer *m, integer *n, 
	    ...
	    integer *ldu, doublecomplex *vt, integer *ldvt, doublecomplex *work, integer *lwork,
