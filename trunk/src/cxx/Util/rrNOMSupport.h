...
//        private ArrayList returnUnitDefinition(UnitDefinition oDefinition)
//        private ASTNode changeSymbol(ASTNode node, const string& time, const int& targetType)
//        private ASTNode changeTimeToCSymbol(ASTNode node, const string& name, const int& type)
//        private bool addMissingModifiers(Model oModel)
//        private List<string> _Namespaces;
//        private List<string> GetSymbols(const string& formula)
//        private ParameterSets _ParameterSets;
//        private string GetInitialAssignmentFor(const string& sbmlId)
//        private string GetName(SBase element)
//        private string GetRuleFor(const string& sbmlId)
//        private void addDependenciesToList(ASTNode node, List<string> sResult)
//        private void AddMissingParameter(const string& parameterId, SBMLDocument doc)
//        private void BuildSymbolTable()
//        private void ChangeNameToCSymbol(Model model, const string& name, const int& type)
//        private void ChangeParameterName(ASTNode node, const string& sParameterName, const string& sPrefix)
//        private void changePow(ASTNode node)
//        private void changeSymbol(Model oModel, const string& sTimeSymbol, const int& targetType)
//        private void changeTimeSymbol(Model model, const string& timeSymbol)
//        private void checkForMissingNames(ASTNode node, StringCollection results, StringCollection symbols)
//        private void GetSymbols(ASTNode node, List<System.String> list)
//        private void LookForDependencies()
//        private void modifyKineticLaws(SBMLDocument oSBMLDoc, Model oModel)
//        private void modifyKineticLawsForLocalParameters(KineticLaw oLaw, const string& reactionId, Model oModel)
//        private void modifyKineticLawsForReaction(KineticLaw oLaw, const string& reactionId, Model oModel)
//        private void RemoveSpatialSizeUnitsFromSpecies(SBMLDocument doc)
//        private void RemoveSubstanceUnitsFromKineticLaws(SBMLDocument doc)
//        private void RemoveTimeUnitsFromKineticLaws(SBMLDocument doc)
//        private void UpdateDependencies(const string& sbmlId)
//        private void UpgradeToL2V4IfNecessary(SBMLDocument doc)
//        public ArrayList getDerivedUnitDefinition(const string& sId)
//        public ArrayList getListOfBoundarySpeciesIds()
//        public ArrayList getListOfErrors()
//        public ArrayList getListOfFloatingSpecies()
//        public ArrayList getListOfFloatingSpeciesIds()
//        public ArrayList getListOfParameters()
//        public ArrayList getNthError(const int& nIndex)
//        public ArrayList getNthEvent(const int& arg)
//        public ArrayList getNthFunctionDefinition(const int& arg)
//        public ArrayList getNthListOfModifiers(const int& nIndex)
//        public ArrayList getNthListOfProducts(const int& nIndex)
//        public ArrayList getNthListOfReactants(const int& nIndex)
//        public ASTNode ReplaceSymbol(ASTNode node, const string& oldId, const string& newId)
//        public bool exists(const string& sId)
//        public bool getNthParameterHasValue(const int& nReactionIndex, const int& nParameterIndex)
//        public bool getNthUseValuesFromTriggerTime(const int& arg)
//        public bool hasInitialAmount(const string& sId)
//        public bool hasInitialConcentration(const string& sId)
//        public bool hasSBOTerm(const string& sId)
//        public bool hasValue(const string& sId)
//        public bool IsBoundary(const string& sId)
//        public bool IsCompartment(const string& sId)
//        public bool isConstantImpl(const string& sId)
//        public bool IsFloating(const string& sId)
//        public bool isReactionReversible(const int& nIndex)
//        public bool IsSpecies (const string& sId)
//        public bool MultiplyCompartment(const string& sbmlId, out const string& compartmentId)
//        public bool NeedEmptySetNode(Model model)
//        public bool NeedSinkNode(Model model)
//        public bool NeedSourceNode(Model model)
//        public double getNthParameterValue(const int& nReactionIndex, const int& nParameterIndex)
//        public double getNthProductStoichiometryDouble(const int& nIndex, const int& nProduct)
//        public double getNthReactantStoichiometryDouble(const int& nIndex, const int& nReactant)
//        public double getValue(const string& sId)
//        public int checkConsistency()
//        public int getNthProductStoichiometry(const int& nIndex, const int& nProduct)
//        public int getNthReactantStoichiometry(const int& nIndex, const int& nReactant)
...
//        public int getNumParameters(int var0)
//        public int getNumProducts(const int& var0)
//        public int getNumReactants(const int& var0)
//        public int getNumReactions()
//        public int getNumRules()
//        public int getSBOTerm(const string& sId)
//        public List<Rule> ReorderAssignmentRules(List<Rule> assignmentRules)
//        public List<string> GetSymbols(ASTNode math)
//        public List<string> Namespaces
//        public Model Model
//        public Model SbmlModel
//        public Pair<string, string> getNthInitialAssignmentPair(const int& nIndex)
//        public ParameterSets ParameterSets
//        public SBase GetElement(const string& sId)
//        public SBMLDocument SbmlDocument
//        public Stack<string> GetMatchForSymbol(const string& sbmlId)
//        public static SBMLDocument Document
//        public string addEmptySetNode(const string& sbml)
//        public string addEmptySetNodes(const string& sbml)
//        public string addMissingModifiers(const string& sModel)
//        public string addSourceSinkNodes(const string& sbml)
//        public string convertLevel1ToLevel2Impl(const string& sSBML)
//        public string convertLevel2ToLevel1Impl(const string& sSBML)
//        public string convertMathMLToString(const string& sMathML)
//        public string convertPowImpl(const string& sSBML)
//        public string convertSBML(const string& sModel, const int& nLevel, const int& nVersion)
//        public string convertSBML(const string& sModel, const int& nLevel, const int& nVersion, bool throwError)
//        public string convertStringToMathML(const string& var0)
//        public string convertTime(const string& sArg, const string& sTimeSymbol)
//        public string convertTimeToCSymbol(const string& sArg, const string& sTimeSymbol)
//        public string FixCommonIssues(const string& sbml)
//        public string FixCommonIssues(const string& sbml, const string& programName, const string& programVersion)
//        public string GetAnnotatedModel(const string& targetSBML, const string& sourceSBML, bool checkModelId)
//        public string getAnnotation(const string& sId)
//        public string getCompartmentIdBySpeciesId(const string& sId)
//        public string GetId(SBase element)
//        public string getKineticLaw(const int& index)
//        public string getMetaId(const string& sId)
//        public string getModelId()
//        public string getModelName()
//        public string getNotes(const string& sId)
//        public string getNthBoundarySpeciesId(const int& nIndex)
//        public string getNthBoundarySpeciesName(const int& nIndex)
//        public string getNthCompartmentId(const int& nIndex)
//        public string getNthCompartmentName(const int& nIndex)
//        public string getNthConstraint(const int& nIndex, out const string& sMessage)
//        public string getNthFloatingSpeciesId(const int& nIndex)
//        public string getNthFloatingSpeciesName(const int& nIndex)
//        public string getNthGlobalParameterId(const int& nIndex)
//        public string getNthGlobalParameterName(const int& nIndex)
//        public string getNthInitialAssignment(const int& nIndex)
//        public string getNthParameterId(const int& nReactionIndex, const int& nParameterIndex)
//        public string getNthParameterName(const int& nReactionIndex, const int& nParameterIndex)
//        public string getNthProductName(const int& nIndex, const int& nProduct)
//        public string getNthReactantName(const int& nIndex, const int& nReactant)
//        public string getNthReactionId(const int& nIndex)
//        public string getNthReactionName(const int& nIndex)
//        public string getNthRule(const int& nIndex)
//        public string getNthRuleType(const int& arg)
//        public string getOutsideCompartment(const string& var0)
//        public string getParamPromotedSBML(const string& sArg)
//        public string getSBML()
//        public string getSBOCapableSBML(const string& sModel)
//        public string RemoveJD1Layout(const string& sSBML)
//        public string RemoveJD2Layout(const string& sSBML)
//        public string RemoveLayoutInformation(const string& sSBML)
//        public string validateSBML(const string& sModel)
//        public string validateWithConsistency(const string& sModel)
//        public string[] getBuiltinFunctionInfo(const string& var0)
//        public string[] getBuiltinFunctions()
//        public void ChangeConstantForRules(Model model)
//        public void FillStack(Stack<string> stack, SBMLSymbol symbol)
//        public void loadFromFile(const string& fileName)
//        public void loadParameterPromotedSBML(const string& var0, const string& sTimeSymbol)
//        public void loadSBML(const string& var0)
//        public void loadSBML(const string& var0, const string& sTimeSymbol)
//        public void ReorderRules(SBMLDocument doc, Model model)
//        public void setAnnotation(const string& sId, const string& sAnnotation)
//        public void setModelId(const string& sId)
//        public void setNotes(const string& sId, const string& sNotes)
//        public void setSBOTerm(const string& sId, const int& nSBOTerm)
//        public void setValue(const string& sId, double dValue)
//        public void setValue(Model model, const string& id, double value, bool throwIfNotFound)
//        public void TestASTTime()
