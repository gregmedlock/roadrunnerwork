...
int CGenerator::NumAdditionalRates()
{
...
StringList CGenerator::getCompartmentList()
{
    StringList tmp;
...
string CGenerator::substituteTerms(const int& numReactions, const string& reactionName, const string& equation)
{
    return substituteTerms(reactionName, equation, false);
}

void CGenerator::SubstituteEquation(const string& reactionName, Scanner& s, StringBuilder& sb)
{
	string theToken(s.tokenString);
    if(theToken == "pow")
    {
...
void CGenerator::SubstituteWords(const string& reactionName, bool bFixAmounts, Scanner& s, StringBuilder& sb)
{
...
void CGenerator::SubstituteToken(const string& reactionName, bool bFixAmounts, Scanner& s, StringBuilder& sb)
{
...
ASTNode* CGenerator::CleanEquation(ASTNode* astP)
{
...
string CGenerator::CleanEquation(const string& eqn)
{
    if (eqn.size() < 1)
    {
    	return "0";
...
string CGenerator::substituteTerms(const string& reactionName, const string& inputEquation, bool bFixAmounts)
{
...
double* CGenerator::InitializeL0(int& nrRows, int& nrCols)
{
	double* L0;
    try
    {
...
void CGenerator::WriteOutSymbolTables(StringBuilder& sb)
{
...
int CGenerator::ReadGlobalParameters()
{
...
void CGenerator::ReadLocalParameters(const int& numReactions,  vector<int>& localParameterDimensions, int& totalLocalParmeters)
{
    string name;
    double value;
...
void CGenerator::WriteComputeAllRatesOfChange(StringBuilder& sb, const int& numIndependentSpecies, const int& numDependentSpecies, DoubleMatrix& L0)
{
...
void CGenerator::WriteComputeConservedTotals(StringBuilder& sb, const int& numFloatingSpecies, const int& numDependentSpecies)
{
...
void CGenerator::WriteUpdateDependentSpecies(StringBuilder& sb, const int& numIndependentSpecies, const int& numDependentSpecies, DoubleMatrix& L0)
{
...
void CGenerator::WriteUserDefinedFunctions(StringBuilder& sb)
{
...
void CGenerator::WriteResetEvents(StringBuilder& sb, const int& numEvents)
{
...
void CGenerator::WriteSetConcentration(StringBuilder& sb)
{
...
void CGenerator::WriteGetConcentration(StringBuilder& sb)
{
...
void CGenerator::WriteConvertToAmounts(StringBuilder& sb)
{
...
void CGenerator::WriteConvertToConcentrations(StringBuilder& sb)
{
...
void CGenerator::WriteProperties(StringBuilder& sb)
{
...
void CGenerator::WriteAccessors(StringBuilder& sb)
{
 ...
 void CGenerator::WriteOutVariables(StringBuilder& sb)
{
...
void CGenerator::WriteClassHeader(StringBuilder& sb)
{
...
void CGenerator::WriteTestConstraints(StringBuilder& sb)
{
...
bool CGenerator::ExpressionContainsSymbol(ASTNode *ast, const string& symbol)
{
...
bool CGenerator::ExpressionContainsSymbol(const string& expression,const string& symbol)
{
...
void CGenerator::WriteEvalInitialAssignments(StringBuilder& sb, const int& numReactions)
{
...
int CGenerator::WriteComputeRules(StringBuilder& sb, const int& numReactions)
{
...
void CGenerator::WriteComputeReactionRates(StringBuilder& sb, const int& numReactions)
{
...
void CGenerator::WriteEvalEvents(StringBuilder& sb, const int& numEvents, const int& numFloatingSpecies)
{
...
void CGenerator::WriteEvalModel(StringBuilder& sb, const int& numReactions, const int& numIndependentSpecies, const int& numFloatingSpecies, const int& numOfRules)
{
...
Symbol* CGenerator::GetSpecies(const string& id)
{
	int index;
...
void CGenerator::WriteEventAssignments(StringBuilder& sb, const int& numReactions, const int& numEvents)
{
	StringList delays;
...
string CGenerator::WriteDouble(const double& value)
{
	return ToString(value, STR_DoubleFormat);
}

void CGenerator::WriteSetParameterValues(StringBuilder& sb, const int& numReactions)
{
...
void CGenerator::WriteSetCompartmentVolumes(StringBuilder& sb)
{
...
void CGenerator::WriteSetBoundaryConditions(StringBuilder& sb)
{
...
void CGenerator::WriteSetInitialConditions(StringBuilder& sb, const int& numFloatingSpecies)
{
...
int CGenerator::ReadCompartments()
{
...
int CGenerator::ReadModifiableSpeciesReferences()
{
